        ...
        >
          <div className='relative w-full h-[230px]'> 
                <Image 
                  ...
                  alt={name}
                  sizes='cover'
                  className='w-full h-full object-cover ronded-2xl'
                />
                <div className='absolute inset-0 flex justify-between m-3 card-img_hover'>
                    <div
                        onClick={() => window.open(live_demo_link, "_blank")}
                        className='black-gradient h-[20px]  rounded-md flex items-center p-4 cursor-pointer'
                    >
...
const Works = () => {
  return (
    <>
      ...
      <div className='mt-20 flex-wrap gap-7 flex'>
